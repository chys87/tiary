...
enum LoadFileRet {
	...
	LOAD_FILE_SUCCESS
	, LOAD_FILE_OBSOLETE   // Obsolete format
...
bool save_file(const char *filename, const std::vector<DiaryEntry *> &entries, const PerFileOptionGroup &, std::string_view password);
